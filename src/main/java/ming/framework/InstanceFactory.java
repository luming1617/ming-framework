...
import ming.framework.core.impl.DefaultClassScanner;
import ming.framework.mvc.HandlerMapping;
import ming.framework.core.ClassScanner;
import ming.framework.core.ConfigHelper;
import ming.framework.dao.DataAccessor;
import ming.framework.dao.impl.DefaultDataAccessor;
import ming.framework.ds.DataSourceFactory;
import ming.framework.ds.impl.DefaultDataSourceFactory;
import ming.framework.mvc.HandlerExceptionResolver;
import ming.framework.mvc.HandlerInvoker;
import ming.framework.mvc.ViewResolver;
import ming.framework.mvc.impl.DefaultHandlerExceptionResolver;
import ming.framework.mvc.impl.DefaultHandlerInvoker;
import ming.framework.mvc.impl.DefaultHandlerMapping;
import ming.framework.mvc.impl.DefaultHandlerViewResolver;
import ming.framework.util.ObjectUtil;
import ming.framework.util.StringUtil;
...
public class InstanceFactory {
    ...
    public static ViewResolver getViewResolver() {
        return getInstance(VIEW_RESOLVER, DefaultHandlerViewResolver.class);
    }
