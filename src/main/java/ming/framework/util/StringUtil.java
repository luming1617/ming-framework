...
public class StringUtil {
    ...
    private final static Pattern PATTERN_AZ_UPPER = Pattern.compile("[A-Z]");

    private final static Pattern PATTERN_AZ_LOWER = Pattern.compile("_[a-z]");
    ...
    public static String camelhumpToUnderline(String str) {
        Matcher matcher = PATTERN_AZ_UPPER.matcher(str);
    ...
    public static String underlineToCamelhump(String str) {
        Matcher matcher = PATTERN_AZ_LOWER.matcher(str);
        StringBuilder builder = new StringBuilder(str);
        for (int i = 0; matcher.find(); i++) {
